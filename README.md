...
| 2026-09-23 | **不再用 Hypixel 延迟推断地区**：60 个真实样本跟 NameMC 自设国家对照，能判定的 14 个里只对 9 个（64%）—— 中国 201ms、韩国 178ms 与英国 222ms、澳洲 234ms 落在同一段，挂加速器的美国玩家也在 120~180ms。现在「地区」只显示有依据的值（NameMC 自设 / 窄语种推测），其余显示 `-`；延迟本身照旧作为事实展示 |
